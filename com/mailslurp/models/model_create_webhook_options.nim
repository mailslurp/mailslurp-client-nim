...
type CreateWebhookOptions* = object
  ...
  useStaticIpRange*: bool ## Use static IP range when calling webhook endpoint
  ignoreInsecureSslCertificates*: bool ## Ignore insecure SSL certificates when sending request. Useful for self-signed certs.

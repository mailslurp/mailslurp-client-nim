...
type WebhookDto* = object
  ...
  ignoreInsecureSslCertificates*: bool ## Should notifier ignore insecure SSL certificates
  useStaticIpRange*: bool ## Should notifier use static IP range when sending webhook payload

...
type CreateAliasOptions* = object
  ...
  name*: string ## Optional name for alias
  ...
  domainId*: string ## Custom domain ID to use when generating alias email addresses
  verifyEmailAddress*: bool ## Whether to verify the masked email address exists before sending an email to it

...
type MatchOption* = object
  ...
  field*: Field ## The email property to match on. One of SUBJECT, TO, BCC, CC or FROM
  should*: Should ## What criteria to apply. CONTAIN or EQUAL. Note CONTAIN is recommended due to some SMTP servers adding new lines to fields and body content.

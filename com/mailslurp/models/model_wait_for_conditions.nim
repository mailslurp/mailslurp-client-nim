...
type WaitForConditions* = object
  ...
  before*: string ## ISO Date Time latest time of email to consider. Filter for matching emails that were received before this date
  ...
  since*: string ## ISO Date Time earliest time of email to consider. Filter for matching emails that were received after this date

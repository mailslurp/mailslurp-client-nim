...
type InboxDto* = object
  ...
  functionsAs*: FunctionsAs ## Inbox function if used as a primitive for another system.
...
func `%`*(v: FunctionsAs): JsonNode =
  let str = case v:
    of FunctionsAs.ALIAS: "ALIAS"
    of FunctionsAs.THREAD: "THREAD"
    of FunctionsAs.CATCHALL: "CATCH_ALL"
    of FunctionsAs.CONNECTOR: "CONNECTOR"

  JsonNode(kind: JString, str: str)

func `$`*(v: FunctionsAs): string =
  result = case v:
    of FunctionsAs.ALIAS: "ALIAS"
    of FunctionsAs.THREAD: "THREAD"
    of FunctionsAs.CATCHALL: "CATCH_ALL"

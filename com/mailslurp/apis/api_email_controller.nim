...
proc getEmailsPaginated*(httpClient: HttpClient, inboxId: seq[string], page: int, searchFilter: string, size: int, sort: string, unreadOnly: bool): (Option[PageEmailProjection], Response) =
...
proc getOrganizationEmailsPaginated*(httpClient: HttpClient, inboxId: seq[string], page: int, searchFilter: string, size: int, sort: string, unreadOnly: bool): (Option[PageEmailProjection], Response) =

...
proc downloadAttachment*(httpClient: HttpClient, emailId: string, attachmentId: string, apiKey: string): (Option[seq[ByteArray]], Response) =
...
proc downloadBodyBytes*(httpClient: HttpClient, emailId: string): (Option[seq[ByteArray]], Response) =
...
proc sendEmailSourceOptional*(httpClient: HttpClient, SendEmailOptions: SendEmailOptions, inboxId: string, useDomainPool: bool): Response =
  ## Send email
  httpClient.headers["Content-Type"] = "application/json"
  let query_for_api_call = encodeQuery([

...
proc getAttachments1*(httpClient: HttpClient, emailId: string): (Option[seq[AttachmentMetaData]], Response) =
...
proc getEmailsPaginated*(httpClient: HttpClient, before: string, inboxId: seq[string], page: int, searchFilter: string, since: string, size: int, sort: string, unreadOnly: bool): (Option[PageEmailProjection], Response) =
...
proc getOrganizationEmailsPaginated*(httpClient: HttpClient, before: string, inboxId: seq[string], page: int, searchFilter: string, since: string, size: int, sort: string, unreadOnly: bool): (Option[PageEmailProjection], Response) =
...
proc sendEmailSourceOptional*(httpClient: HttpClient, inboxId: string, useDomainPool: bool, sendEmailOptions: SendEmailOptions): Response =
  ## Send email
  httpClient.headers["Content-Type"] = "application/json"
  let query_for_api_call = encodeQuery([

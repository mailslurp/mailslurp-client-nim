...
proc sendEmailSourceOptional*(httpClient: HttpClient, inboxId: string, SendEmailOptions: SendEmailOptions, useDomainPool: bool, virtualSend: bool): Response =
  ## Send email
  httpClient.headers["Content-Type"] = "application/json"
  let query_for_api_call = encodeQuery([
  ...
  httpClient.post(basepath & fmt"/emails" & "?" & query_for_api_call, $(%SendEmailOptions))

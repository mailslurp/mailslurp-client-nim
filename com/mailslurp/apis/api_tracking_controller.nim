...
proc getAllTrackingPixels*(httpClient: HttpClient, before: string, page: int, searchFilter: string, since: string, size: int, sort: string): (Option[PageTrackingPixelProjection], Response) =
  ## Get tracking pixels

...
proc getAllTrackingPixels*(httpClient: HttpClient, page: int, size: int, sort: string, searchFilter: string, since: string, before: string): (Option[PageTrackingPixelProjection], Response) =
  ## Get tracking pixels

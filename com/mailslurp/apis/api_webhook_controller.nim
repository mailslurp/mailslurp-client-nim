...
import ../models/model_webhook_payload
...
proc getTestWebhookPayload*(httpClient: HttpClient): (Option[WebhookPayload], Response) =
  ## Get test webhook payload example

  let response = httpClient.get(basepath & "/webhooks/test")
  constructResult[WebhookPayload](response)

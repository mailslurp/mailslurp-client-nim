...
proc deleteAllWebhooks*(httpClient: HttpClient): Response =
  ## Delete all webhooks
  httpClient.delete(basepath & "/webhooks")
...
proc getAllWebhookResults*(httpClient: HttpClient, before: string, page: int, searchFilter: string, since: string, size: int, sort: string, unseenOnly: bool): (Option[PageWebhookResult], Response) =
...
proc getWebhookResults*(httpClient: HttpClient, webhookId: string, before: string, page: int, searchFilter: string, since: string, size: int, sort: string, unseenOnly: bool): (Option[PageWebhookResult], Response) =
...
proc getWebhookResultsUnseenErrorCount*(httpClient: HttpClient, inboxId: string): (Option[UnseenErrorCountDto], Response) =
  ## Get count of unseen webhook results with error status

  let response = httpClient.get(basepath & fmt"/webhooks/results/unseen-count")

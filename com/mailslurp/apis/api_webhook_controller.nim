...
proc getAllWebhookResults*(httpClient: HttpClient, page: int, size: int, sort: string): (Option[PageWebhookResult], Response) =
...
proc getWebhookResults*(httpClient: HttpClient, webhookId: string, page: int, size: int, sort: string): (Option[PageWebhookResult], Response) =

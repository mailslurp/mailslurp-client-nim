...
proc deleteAllValidationRequests*(httpClient: HttpClient): Response =
  ## Delete all validation requests
  httpClient.delete(basepath & "/email-verification")


proc deleteValidationRequest*(httpClient: HttpClient, id: string): Response =
  ## Delete a validation record
  httpClient.delete(basepath & fmt"/email-verification/{id}")

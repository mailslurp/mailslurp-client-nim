...
import ../models/model_check_email_features_client_support_options
import ../models/model_check_email_features_client_support_results
...
proc checkEmailFeaturesClientSupport*(httpClient: HttpClient, CheckEmailFeaturesClientSupportOptions: CheckEmailFeaturesClientSupportOptions): (Option[CheckEmailFeaturesClientSupportResults], Response) =
  ## Check email client support for email HTML and CSS features
  httpClient.headers["Content-Type"] = "application/json"

  let response = httpClient.post(basepath & "/tools/check-email-features-client-support", $(%CheckEmailFeaturesClientSupportOptions))
  constructResult[CheckEmailFeaturesClientSupportResults](response)

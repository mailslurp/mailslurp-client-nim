...
proc createNewInboxForwarder*(httpClient: HttpClient, createInboxForwarderOptions: CreateInboxForwarderOptions, inboxId: string): (Option[InboxForwarderDto], Response) =
...
proc getInboxForwarders*(httpClient: HttpClient, before: string, inboxId: string, page: int, searchFilter: string, since: string, size: int, sort: string): (Option[PageInboxForwarderDto], Response) =

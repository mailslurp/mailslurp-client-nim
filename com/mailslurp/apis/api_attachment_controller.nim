...
proc getAttachments*(httpClient: HttpClient, before: string, fileNameFilter: string, page: int, since: string, size: int, sort: string): (Option[PageAttachmentEntity], Response) =

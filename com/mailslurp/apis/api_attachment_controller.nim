...
proc downloadAttachmentAsBytes*(httpClient: HttpClient, attachmentId: string): (Option[seq[ByteArray]], Response) =
...
proc getAttachments1*(httpClient: HttpClient, page: int, size: int, sort: string, fileNameFilter: string, since: string, before: string): (Option[PageAttachmentEntity], Response) =
...
proc uploadAttachmentBytes*(httpClient: HttpClient, ByteArray: seq[ByteArray], contentType: string, filename: string): (Option[seq[string]], Response) =

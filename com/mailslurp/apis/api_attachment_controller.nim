...
proc getAttachments*(httpClient: HttpClient, page: int, size: int, sort: string): (Option[PageAttachmentEntity], Response) =
...
proc uploadAttachmentBytes*(httpClient: HttpClient, String: string, filename: string, byteArray: ByteArray): (Option[seq[string]], Response) =
  ## Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
  httpClient.headers["Content-Type"] = "application/json"
  let query_for_api_call = encodeQuery([
    ("String", $String), # Optional contentType for file. For instance `application/pdf`

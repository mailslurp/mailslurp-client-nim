...
proc getAllMissedEmails*(httpClient: HttpClient, inboxId: string, page: int, searchFilter: string, size: int, sort: string): (Option[PageMissedEmailProjection], Response) =
...
proc getAllUnknownMissedEmails*(httpClient: HttpClient, inboxId: string, page: int, searchFilter: string, size: int, sort: string): (Option[PageUnknownMissedEmailProjection], Response) =
...
proc waitForNthMissedEmail*(httpClient: HttpClient, inboxId: string, index: int, timeout: int64): (Option[MissedEmail], Response) =

...
proc getAllMissedEmails*(httpClient: HttpClient, before: string, inboxId: string, page: int, searchFilter: string, since: string, size: int, sort: string): (Option[PageMissedEmailProjection], Response) =
...
proc getAllUnknownMissedEmails*(httpClient: HttpClient, before: string, inboxId: string, page: int, searchFilter: string, since: string, size: int, sort: string): (Option[PageUnknownMissedEmailProjection], Response) =
...
proc waitForNthMissedEmail*(httpClient: HttpClient, before: string, inboxId: string, index: int, since: string, timeout: int64): (Option[MissedEmail], Response) =

...
proc createNewEmailAddress1*(httpClient: HttpClient, allowTeamAccess: bool, useDomainPool: bool, expiresAt: string, expiresIn: int64, emailAddress: string, inboxType: string, description: string, name: string, tags: seq[string], favourite: bool): (Option[InboxDto], Response) =
  ## Create new random inbox
  let query_for_api_call = encodeQuery([
    ("allowTeamAccess", $allowTeamAccess), # 
    ("useDomainPool", $useDomainPool), # 

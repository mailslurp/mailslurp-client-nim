...
proc getAliasEmails*(httpClient: HttpClient, aliasId: string, before: string, page: int, since: string, size: int, sort: string): (Option[PageEmailProjection], Response) =
...
proc getAliasThreads*(httpClient: HttpClient, aliasId: string, before: string, page: int, since: string, size: int, sort: string): (Option[PageThreadProjection], Response) =
...
proc getAliases*(httpClient: HttpClient, before: string, page: int, since: string, size: int, sort: string): (Option[PageAlias], Response) =

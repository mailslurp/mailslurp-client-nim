...
proc waitForEmailCount*(httpClient: HttpClient, before: string, count: int, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =
...
proc waitForLatestEmail*(httpClient: HttpClient, before: string, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =
...
proc waitForMatchingEmails*(httpClient: HttpClient, matchOptions: MatchOptions, before: string, count: int, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =
...
proc waitForMatchingFirstEmail*(httpClient: HttpClient, matchOptions: MatchOptions, before: string, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =
...
proc waitForNthEmail*(httpClient: HttpClient, before: string, delay: int64, inboxId: string, index: int, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =

...
proc waitForMatchingEmail*(httpClient: HttpClient, matchOptions: MatchOptions, count: int, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =

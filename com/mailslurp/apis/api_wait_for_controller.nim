...
proc waitForEmailCount*(httpClient: HttpClient, count: int, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =
...
proc waitForLatestEmail*(httpClient: HttpClient, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =
...
proc waitForMatchingEmails*(httpClient: HttpClient, matchOptions: MatchOptions, count: int, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =
...
proc waitForMatchingFirstEmail*(httpClient: HttpClient, matchOptions: MatchOptions, delay: int64, inboxId: string, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =
...
proc waitForNthEmail*(httpClient: HttpClient, delay: int64, inboxId: string, index: int, since: string, sort: string, timeout: int64, unreadOnly: bool): (Option[Email], Response) =

...
proc bulkCreateInboxes*(httpClient: HttpClient, count: int): (Option[seq[Inbox]], Response) =
...
proc bulkDeleteInboxes*(httpClient: HttpClient, ids: seq[string]): Response =
  ## Bulk Delete Inboxes
  httpClient.headers["Content-Type"] = "application/json"
  httpClient.delete(basepath & "/bulk/inboxes", $(%ids))

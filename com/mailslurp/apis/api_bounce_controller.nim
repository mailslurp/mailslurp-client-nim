...
proc getAccountBounceBlockStatus*(httpClient: HttpClient): (Option[AccountBounceBlockDto], Response) =
  ## Can account send email

  let response = httpClient.get(basepath & "/bounce/account-block")
  constructResult[AccountBounceBlockDto](response)
...
proc getComplaint*(httpClient: HttpClient, id: string): (Option[Complaint], Response) =
  ## Get complaint

  let response = httpClient.get(basepath & fmt"/bounce/complaints/{id}")
  constructResult[Complaint](response)

...
proc getBouncedEmails*(httpClient: HttpClient, before: string, page: int, since: string, size: int, sort: string): (Option[PageBouncedEmail], Response) =
...
proc getBouncedRecipients*(httpClient: HttpClient, before: string, page: int, since: string, size: int, sort: string): (Option[PageBouncedRecipients], Response) =

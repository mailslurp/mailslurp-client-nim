...
proc getBouncedEmail*(httpClient: HttpClient, id: string): (Option[Bounce], Response) =
  ## Get a bounced email.

  let response = httpClient.get(basepath & fmt"/bounce/emails/{id}")
  constructResult[Bounce](response)


proc getBouncedEmails*(httpClient: HttpClient, page: int, size: int, sort: string): (Option[PageBouncedEmail], Response) =
...
proc getBouncedRecipient*(httpClient: HttpClient, id: string): (Option[BounceRecipient], Response) =
  ## Get a bounced email.

  let response = httpClient.get(basepath & fmt"/bounce/recipients/{id}")
  constructResult[BounceRecipient](response)


proc getBouncedRecipients*(httpClient: HttpClient, page: int, size: int, sort: string): (Option[PageBouncedRecipients], Response) =

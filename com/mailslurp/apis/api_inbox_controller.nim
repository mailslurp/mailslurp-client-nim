...
proc createInbox*(httpClient: HttpClient, emailAddress: string, tags: seq[string], name: string, description: string, useDomainPool: bool, favourite: bool, expiresAt: string, expiresIn: int64, allowTeamAccess: bool, inboxType: string): (Option[InboxDto], Response) =
...
proc getEmails*(httpClient: HttpClient, inboxId: string, Alias for limit. Assessed first before assessing any passed limit.: int, limit: int, Sort the results by received date and direction ASC or DESC: string, retryTimeout: int64, delayTimeout: int64, minCount: int64, unreadOnly: bool, before: string, since: string): (Option[seq[EmailPreview]], Response) =

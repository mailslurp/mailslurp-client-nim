...
proc sendWithSchedule*(httpClient: HttpClient, inboxId: string, SendEmailOptions: SendEmailOptions, sendAtTimestamp: string, sendAtNowPlusSeconds: int64, validateBeforeEnqueue: bool): Response =
  ...
  httpClient.post(basepath & fmt"/inboxes/{inboxId}/with-schedule" & "?" & query_for_api_call, $(%SendEmailOptions))

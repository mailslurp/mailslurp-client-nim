...
proc getEmails*(httpClient: HttpClient, inboxId: string, delayTimeout: int64, limit: int, minCount: int64, retryTimeout: int64, since: string, size: int, sort: string, unreadOnly: bool): (Option[seq[EmailPreview]], Response) =

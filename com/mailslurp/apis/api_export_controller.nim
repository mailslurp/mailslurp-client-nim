...
proc exportEntities*(httpClient: HttpClient, exportType: string, apiKey: string, outputFormat: string, filter: string, listSeparatorToken: string, excludePreviouslyExported: bool, createdEarliestTime: string, createdOldestTime: string): (Option[ByteArray], Response) =

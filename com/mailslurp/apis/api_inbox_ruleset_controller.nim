...
import ../models/model_page_inbox_ruleset_projection
...
proc getInboxRulesets*(httpClient: HttpClient, inboxId: string, page: int, size: int, sort: string): (Option[PageInboxRulesetProjection], Response) =
  ## List inbox rulesets
  let query_for_api_call = encodeQuery([
  ...
  constructResult[PageInboxRulesetProjection](response)

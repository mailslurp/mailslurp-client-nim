...
proc getInboxRulesets*(httpClient: HttpClient, before: string, inboxId: string, page: int, searchFilter: string, since: string, size: int, sort: string): (Option[PageInboxRulesetDto], Response) =
  ## List inbox rulesets
  let query_for_api_call = encodeQuery([

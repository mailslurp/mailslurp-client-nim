...
proc getExpiredInboxRecord*(httpClient: HttpClient, ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId): string): (Option[ExpiredInboxDto], Response) =
...
proc getExpiredInboxes*(httpClient: HttpClient, page: int, size: int, sort: string, since: string, before: string): (Option[PageExpiredInboxRecordProjection], Response) =

...
proc getAllGroups*(httpClient: HttpClient, before: string, page: int, since: string, size: int, sort: string): (Option[PageGroupProjection], Response) =
...
proc getGroupWithContactsPaginated*(httpClient: HttpClient, groupId: string, before: string, page: int, since: string, size: int, sort: string): (Option[PageContactProjection], Response) =

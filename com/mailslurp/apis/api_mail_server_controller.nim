...
proc describeMailServerDomain*(httpClient: HttpClient, describeOptions: DescribeDomainOptions): (Option[DescribeMailServerDomainResult], Response) =
  ## Get DNS Mail Server records for a domain
  httpClient.headers["Content-Type"] = "application/json"

  let response = httpClient.post(basepath & "/mail-server/describe/domain", $(%describeOptions))
...
proc verifyEmailAddress*(httpClient: HttpClient, verifyOptions: VerifyEmailAddressOptions): (Option[EmailVerificationResult], Response) =
  ## Verify the existence of an email address at a given mail server.
  httpClient.headers["Content-Type"] = "application/json"

  let response = httpClient.post(basepath & "/mail-server/verify/email-address", $(%verifyOptions))

...
proc getAllContacts*(httpClient: HttpClient, page: int, size: int, sort: string, since: string, before: string): (Option[PageContactProjection], Response) =
  ## Get all contacts
...
proc getContactVCard*(httpClient: HttpClient, contactId: string): (Option[seq[ByteArray]], Response) =

...
proc getAllContacts*(httpClient: HttpClient, page: int, size: int, sort: string, since: string, before: string, search: string): (Option[PageContactProjection], Response) =
  ## Get all contacts
...
proc getContactVCard*(httpClient: HttpClient, contactId: string): Response {.deprecated.} =
  ## Get contact vCard vcf file
  httpClient.get(basepath & fmt"/contacts/{contactId}/download")
